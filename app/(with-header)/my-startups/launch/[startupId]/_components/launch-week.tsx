...
const LaunchWeek = () => {
  ...
  const LaunchOptions = () => (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
      <div className="flex flex-col justify-between border rounded-lg p-4 h-80">
        <div>
          <div className="font-medium text-xl mb-2">Free Launch</div>
          <div className="text-sm mb-2">What you get:</div>
          <ul>
            {FREE_LAUNCH_BENEFITS.map((benefit, index) => (
              <li
                key={index}
      ...
      <div className="flex flex-col justify-between border rounded-lg p-4 h-80">
        <div>
          <div className="font-semibold text-2xl mb-1">Premium Launch</div>
          <div className="text-sm mb-2">What you get:</div>
          <ul>
            {PREMIUM_LAUNCH_BENEFITS.map((benefit, index) => (
              <li
                key={index}
                className="flex items-center gap-1.5 text-sm justify-start mb-1"
              >
